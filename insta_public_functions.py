...
class GetInstagramProfile():    
    ...
    def scrape_users_post_likes(self,user_name,un,psw):
        ...
        for post in profile.get_posts():
            ...
            postsdf.loc[len(postsdf.index)] = [post_url,post_caption,post_shortcode,post_mediaid,post_title,post_date_time,post_typename,post_mediacount,post_caption_hashtags,post_caption_mentions,post_tagged_users,post_likes,post_comments]
    ...
    def scrape_users_info(self,user_name,un,psw):
        ...
        fdf.loc[len(fdf.index)] = [userid,username,full_name,followers_count,followees_count,mediacount,profile_pic_url,is_private,as_of_date]
        print(fdf)
